...
/**
 * 모든 요청을 중앙 집중적으로 관리해줄 진입점 web.mvc.controller = FrontController 이다
 */
...
public class DispatcherServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try {
            ...
            Method method = className.getMethod(methodName, HttpServletRequest.class, HttpServletResponse.class); // web.mvc.controller 함수들의 공통적인 파라미터
